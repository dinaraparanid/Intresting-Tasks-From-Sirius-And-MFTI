...
В первой строке даны два натуральных числа N и M (1 <= N, M <= 1000). Далее в N строках расположено по M чисел, разделенных пробелами (число равно 0, если в позиции отсутствует
